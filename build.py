...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','net.imthinker.modules.tiextendweb.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','NetImthinkerModulesTiextendwebModuleAssets.m')
